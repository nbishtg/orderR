...
class XTSConnect(XTSCommon):
    ...
    cfg.read('/root/new/order2/config.ini')


    # Default root API endpoint. It's possible to
    # override this by passing the `root` parameter during initialisation.
    # _default_root_uri = cfg.get('root_url', 'root')                  changes
    # _default_marketdataroot_uri = cfg.get('root_url', 'root')          
    ...
    def __init__(self,
        ...
        self._hostlookup_uri=root    
        self._accesspassword = _accesspassword
        self._version = _version      #changes
    ...
    def _request(self, route, method, parameters=None):
        ...
        # if("marketdata" in uri or "apimarketdata" in uri):              changes
