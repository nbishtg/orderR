...
class OrderSocket_io(socketio.Client):
    ...
    def __init__(self, token, userID, port,socketio_path, reconnection=True, reconnection_attempts=0, reconnection_delay=1,
        ...
        # self.port = configParser.get('root_url', 'socketroot').strip()
        self.port=port
